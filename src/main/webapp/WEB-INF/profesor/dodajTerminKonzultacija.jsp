...
<body>
	...
	<p>&nbsp;</p>
	<form action="/ednevnik/servleti/profesor/dodajTerminKonzultacija" method="post">
		Termin i mjesto konzultacija:<input type="text" name="konzultacije" value="${profesor.konzultacije }" required><br>
