...
/**
 * Servlet koji dohvaća predmete i prosljeđuje ih na ispis.
 * 
 * @author Zlatko
 *
 */
@WebServlet(urlPatterns = { "/servleti/admin/ispisPredmeta" })
public class IspisPredmetaServlet extends HttpServlet {
	/***/
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/admin/ispisPredmeta.jsp").forward(req, resp);
	}
}
