 ...
 *
 */
@WebServlet("/servleti/roditelj/ispisPredemetaDjeteta")
public class IspisPredmetaDjetetaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/roditelj/ispisPredmetaDjeteta.jsp").forward(req,resp);
	}
}
