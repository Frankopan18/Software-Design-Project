 ...
 *
 */
@WebServlet("/servleti/roditelj/ispisKontaktnihPodatakaProfesoraRoditelj")
public class IspisKontaktnihPodatakaProfesora extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/roditelj/ispisKontaktnihPodatakaProfesoraRoditelj.jsp").forward(req, resp);
	}
}
