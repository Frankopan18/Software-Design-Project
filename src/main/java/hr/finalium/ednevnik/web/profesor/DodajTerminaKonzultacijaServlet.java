 ...
 *
 */
@WebServlet("/servleti/profesor/dodajTerminKonzultacija")
public class DodajTerminaKonzultacijaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/profesor/dodajTerminKonzultacija.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Profesor profesor = (Profesor) k;
		String konzultacije = req.getParameter("konzultacije");
		profesor.setKonzultacije(konzultacije);
